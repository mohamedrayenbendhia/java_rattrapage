...
public class ClientRatingController implements Initializable {
    ...
    private void initializeTables() {
        ...
        actionColumn.setCellFactory(col -> new TableCell<User, Void>() {
            ...
            {
                rateButton.setStyle("-fx-background-color: #3498db; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 5 15; -fx-background-radius: 3;");
                ...
                if (empty) {
                    ...
                    try {
                        if (ratingService.hasUserRatedUser(currentUser.getId(), user.getId())) {
                            ...
                            rateButton.setStyle("-fx-background-color: #27ae60; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 5 15; -fx-background-radius: 3;");
    ...
    private void showRatingDialog(User userToRate) {
        ...
        starsComboBox.setStyle("-fx-padding: 10; -fx-font-size: 14px;");
        ...
        commentArea.setStyle("-fx-padding: 10; -fx-font-size: 14px;");
        ...
        rateButton.setStyle("-fx-background-color: #3498db; -fx-text-fill: white; -fx-font-weight: bold; -fx-padding: 10 20; -fx-background-radius: 5;");
